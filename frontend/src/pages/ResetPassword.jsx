      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="w-full overflow-hidden rounded-3xl border border-white/80 bg-white/90 shadow-2xl shadow-slate-300/40 backdrop-blur-xl">
          <div className="border-b border-slate-200/80 bg-white/70 px-8 py-7 text-center">
            ...
            <p className="mt-2 text-sm font-medium text-slate-500">Create a new secure password</p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-500" htmlFor="password">
                  New Password
                </label>
                <input
                  id="password"
              ...
              <div>
                <label className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-500" htmlFor="confirmPassword">
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
